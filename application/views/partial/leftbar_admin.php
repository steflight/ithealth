...
<section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <!--<li><a href="#"><i class="fa fa-link"></i> <span>Another Link</span></a></li>-->
             ...
             <li class="treeview">
               <a href="<?= site_url('/acquistion') ?>"><i class="fa fa-link"></i> <span>Approvisionnement</span> <i class="fa fa-angle-left pull-right"></i></a>
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                  <li><a href="<?= site_url('auth/create_user') ?>"><button  data-action="nouveau_ordre_entree" class="btn bg-purple margin">Ajouter utilisateur</button></a></li> 
                  <li><a href="<?= site_url('auth') ?>"><button  data-action="nouveau_ordre_entree" class="btn bg-purple margin">Consulter utilisateurs</button></a></li> 
              </ul>
            </li>
