...
/**
 * interface d'accueil de la gestion des stocks
 */
...
<div class="col-md-12">
              <div class="box box-primary box-solid">
                <div class="box-header with-border">
                  <h3 class="box-title" id="action-text">Consulter l'inventaire</h3>
                  <div class="box-tools pull-right">
                    <button class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i></button>
                  </div><!-- /.box-tools -->
                </div><!-- /.box-header -->
                <div class="box-body" style="display: block;" id="1-action">
                  cliquer ici pour consulter l'inventaire <a href="<?= site_url('inventaire/materiel') ?>"><button  data-action="nouveau_orde" class="btn bg-purple margin">Inventaire</button></a>
                  <p>
...
<div class="col-md-12">
              <div class="box box-primary box-solid">
                ...
                <div id="2-action" class="box-body" style="display: block;">
                    cliquez ici pour voir l'inventaire en fonction des ordres d'entrée
