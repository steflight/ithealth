...
class Ion_auth
{
    ...
    /**
     * 
     * ceci est une solution provisoire, 
     * hahaha  la pragmatisme est cours ....
     */  
    public function getmatname($id = 2)
    {
       $result =  $this->mon_model->getbyidinc('materiel',$id);
       return $result->row();
    }
    
    public function getdetname($id = 2)
    {
       $result =  $this->mon_model->getbyidinc('users',$id);
