		...
		else
		{
			...
			foreach ($this->data['users'] as $k => $user)
			{
				$this->data['users'][$k]->groups = $this->ion_auth->get_users_groups($user->id)->result();
                        ...
                        $this->output('auth/index', $this->data);
                        //$this->data['vue'] = 'auth/index' ;
//			$this->_render_page('auth/index', $this->data);
		...
		else
		{
			...
			$this->data['password'] = array('name' => 'password',
				...
				'type' => 'password',
                       ...
                       //$this->output('auth/login1', $this->data);
                      //  $this->output('auth/login', $this->data);
                        $this->load->view('auth/login1', $this->data);
	...
	function create_user()
	{
		...
		$this->form_validation->set_rules('matricule', $this->lang->line('create_user_validation_matricule_label'), 'required');
		...
		else
		{
			...
			$this->data['matricule'] = array(
				'name'  => 'matricule',
				'id'    => 'matricule',
				'type'  => 'text',
				'value' => $this->form_validation->set_value('matricule'),
			);
			...
			//$this->_render_page('auth/create_user', $this->data);
                        ...
                        $this->output('auth/create_user', $this->data);
		}
	}
	...
	function edit_user($id)
	{
		...
		$this->data['matricule'] = array(
			...
			'id'    => 'matricule',
			'type'  => 'text',
			'value' => $this->form_validation->set_value('matricule', $user->matricule),
		);
		...
		//$this->_render_page('auth/edit_user', $this->data);
                $this->output('auth/edit_user', $this->data);
	}
	...
	function create_group()
	{
		...
		else
		{
			...
			//$this->_render_page('auth/create_group', $this->data);
                        $this->output('auth/create_group', $this->data);
		}
	}
